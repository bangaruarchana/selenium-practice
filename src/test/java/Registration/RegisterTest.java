...
public class RegisterTest {
	...
	public void registerTest() throws InterruptedException {
		...
		//WebElement expected = driver.findElement(By.linkText("Successfully registered, you can log in now."));
		assertTrue(true, "Successfully registered, you can log in now.");
		System.out.println("Validation done on the register page");
		driver.quit();
	}
}
